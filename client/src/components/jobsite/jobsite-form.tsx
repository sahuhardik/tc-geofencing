...
export default function CreateOrUpdateJobSiteForm({ initialValues }: IProps) {
  ...
  const { mutate: createJobSite, isLoading: creating } = useCreateJobSiteMutation();
      ...
      <div className="flex flex-wrap my-5 sm:my-8">
        <Description
          ...
          details={`${initialValues ? t('form:item-description-edit') : t('form:item-description-add')} ${t(
            'form:jobsite-form-description-details'
          )}`}
