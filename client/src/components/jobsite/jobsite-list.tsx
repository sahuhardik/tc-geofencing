...
import { mapMarkerColors, ILatLng } from '@components/widgets/google-map-components';
...
const JobsiteItem = (jobsite: IJobsiteItemProps) => {
  return (
    <Accordion
      key={jobsite.id}
      heading={
        <JobsiteItemCardHeading {...jobsite} />
      }
      actions={
        <JobsiteCardAction {...jobsite} />
      }
    >
