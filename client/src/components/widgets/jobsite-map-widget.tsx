...
export const JobsiteMapWidget = ({
  ...
  const jobSiteColors = ['#A12687', '#5B4D99', '#0099cc', '#cc9900', '#99ff66', '#9900cc', '#009973'];
  ...
  const jobsiteMapsData: IJobSiteMap[] = jobSites.map(
    (jobSite, i) =>
      ({
        ...
        members: jobSite.jobSiteUsers?.map((jobsiteUser) => ({
  ...
  const firstJobsite = jobsiteMapsData[0];
