...
const classes = {
  root: 'inline-flex items-center justify-center  flex-shrink-0 font-medium leading-none rounded outline-none transition duration-300 ease-in-out focus:outline-none focus:shadow focus:ring-1 focus:ring-accent-700',
