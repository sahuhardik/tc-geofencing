          ...
          >
            <div className="absolute inset-0 overflow-hidden">
              <motion.div
                ...
                onClick={onClose}
                className={cn('absolute inset-0 bg-dark bg-opacity-40', useBlurBackdrop && 'use-blur-backdrop')}
              />
              <div
                className={cn(
              ...
              >
                <div className="h-full w-screen max-w-md">
                  <div className="h-full flex flex-col text-body bg-light shadow-xl">{children}</div>
                </div>
              </div>
            </div>
          </motion.aside>
