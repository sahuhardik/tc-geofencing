...
type CounterProps = {
  value: number;
  variant?: 'helium' | 'neon' | 'argon' | 'oganesson' | 'single' | 'details' | 'pillVertical' | 'big';
...
const Counter: React.FC<CounterProps> = ({
  ...
  return (
    <div className={cn('flex overflow-hidden', variantClasses[variant], className)}>
      <button
        onClick={onDecrement}
        className={cn('cursor-pointer p-2 transition-colors duration-200 focus:outline-none hover:bg-accent-hover', {
